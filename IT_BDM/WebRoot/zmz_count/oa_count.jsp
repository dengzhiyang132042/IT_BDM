...
<html>
  <head>
	...
	function queryDetails(dates,datee,state) {
		...
		a2=datee.split(" ");
		//console.log(a2[0]);
		var path="<%=path%>/oa!queryOfFenye?cz=no&id=&job="+state+"&dates="+a1[0]+"&datee="+a2[0];
		//console.log(path);
  ...
  <body>
    ...
    <table border="1" id="" style="font-size: 12px;">
	    ...
	    <%} %>
	    	...
	    	<td>${count.count }</td>
	    	<td>
				<a onclick="queryDetails('${count.sTime}','${count.eTime }','${count.job }')" class="easyui-linkbutton" title="查看详情">查看详情</a>
			</td>
