...
<html>
  ...
  <body>
    ...
    <div class="easyui-panel" title="网点巴枪维护登记-快递单号" style="width:100%;padding: 5px;display: none;" data-options="tools:'#tt'">
    
    <div class="kscx">
   		<div class="inp">
	    	<form id="ks" action="<%=path %>/exp!queryOfFenye" method="post">
	    		<div>
		    		<div>
