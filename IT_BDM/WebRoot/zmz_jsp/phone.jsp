...
<html>
  ...
  <body>
    ...
    <div class="easyui-panel" title="电话线分布" style="width:100%;padding: 5px;display: none;" data-options="tools:'#tt'">
	...
	<div id="in" class="easyui-window" title="数据导入" data-options="modal:true,closed:true" style="width:400px;height:auto;padding:10px;display: none;overflow-x:hidden;">
		<form id="ff" action="<%=path %>/phone!importExcel" method="post" enctype="multipart/form-data">
		<table border="1">
			<tr>
				<td>Excel模板</td>
				<td onmousemove="$(this).css('background-color','red');" onmouseout="$(this).css('background-color','white');" style="cursor: pointer;" onclick="window.location.href='<%=path%>/files/import/zmz/电话线分布.xlsx';">
					下载模板
				</td>
			</tr>
			<tr>
