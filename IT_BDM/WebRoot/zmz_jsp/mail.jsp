...
<html>
  ...
  <body>
    <div class="easyui-panel" title="邮箱账号登记" style="width:100%;padding: 5px;display: none;" data-options="tools:'#tt'">
	...
	<div id="a" class="easyui-window" title="添加" data-options="modal:true,closed:true" style="width:380px;height:auto;padding:10px;display: none;">
		...
		<table border="0" class="table1">
			<tr>
				<td width="80">维护日期：</td>
				<td>
					<input id="serdate" name="m.MServiceDate" type="text" style="width: 100%;" onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" class="Wdate" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%>"/>
				</td>
			</tr>
			<tr>
				<td>部门：</td>
	...
	<div id="in" class="easyui-window" title="数据导入" data-options="modal:true,closed:true" style="width:400px;height:auto;padding:10px;display: none;overflow-x:hidden;">
		<form id="ff" action="<%=path %>/mail!importExcel" method="post" enctype="multipart/form-data">
		<table border="1">
			<tr>
				<td>Excel模板</td>
