  ...
  <body>
    ...
    <tr>
		...
		<td width="5%" align="center">
			<a onclick="update('${b.BId }','<fmt:formatDate value="${b.BRegisterDate }" pattern="yyyy-MM-dd" />','${b.BNum }','${b.BName }','${b.BNetNumber }','${b.BNetName }','${b.BSection }','<fmt:formatDate value="${b.BServiceDate }" pattern="yyyy-MM-dd" />')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" title="修改"></a>
	...
	<div id="u" class="easyui-window" title="修改" data-options="modal:true,closed:true" style="width:500px;height:auto;padding:10px;display: none;">
		...
		<table border="0" class="table1">
			...
			<tr>
				<td>登记日期：</td>
				<td>
					<input id="u_2" name="b.RegisterDate" type="date" style="width: 100%;"/>
				</td>
			</tr>
			<tr>
				<td>BQQ：</td>
			...
			<tr>
				<td>所属网点代码：</td>
				<td>
					<input id="u_5" name="b.BNetNum" type="text" style="width: 100%;"/>
				</td>
			</tr>
			<tr>
				<td>所属网点名称：</td>
