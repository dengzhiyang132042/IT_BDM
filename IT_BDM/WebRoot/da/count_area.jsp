...
<html>
  ...
  <body>
    ...
    <div class="tab" style="float: left;background-color: #FF0202;color: white;font-weight: ;margin-left: 10px;">区域统计</div>
 	...
 	<div class="kscx">
   		<div class="inp">
	    	<form id="ks" action="<%=path %>/countArea!queryOfFenye" method="post">
	    		<div>
		    		<div id="datearea_1">
