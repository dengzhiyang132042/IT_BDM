...
public class XtBqRepairCountServiceImpl extends BaseService implements iXtBqRepairCountService{
...
//		        System.out.println(cal2.getTime());
				...
				str=str+" and RDate <='"+sdf.format(cal2.getTime())+"'";
				str1=str1+" and RDate >='"+sdf.format(cal1.getTime())+"'";
			}
			if(dt.equals("M")){
//				System.out.println(dates);
//				System.out.println(datee);	
