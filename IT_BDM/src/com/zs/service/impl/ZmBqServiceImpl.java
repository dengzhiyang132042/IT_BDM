...
public class ZmBqServiceImpl extends BaseService implements iDataImportService{
	...
	public void importExcelData(String fileName, File file) {
		try {
			...
			for (int i = 1; i < list.size(); i++) {
				try {
					ZmBq bq=new ZmBq("b"+NameOfDate.getNum(), list.get(i)[0], list.get(i)[1], list.get(i)[2], list.get(i)[3], list.get(i)[4],
							list.get(i)[5], list.get(i)[6], list.get(i)[7], list.get(i)[8], new Date());
					save(bq);
				} catch (Exception e) {
