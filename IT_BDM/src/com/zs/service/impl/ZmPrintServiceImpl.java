	...
	public void importExcelData(String fileName, File file,String unum) {
		try {
			...
			for (int i = 1; i < list.size(); i++) {
				try {
					ZmComputer computer=new ZmComputer("c"+NameOfDate.getNum(), null, list.get(i)[0],
							...
							list.get(i)[11], list.get(i)[12], list.get(i)[13], list.get(i)[14], 
							list.get(i)[15], list.get(i)[16], list.get(i)[17], new Date(),"注册",
